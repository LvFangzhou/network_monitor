...
from app.models.resource import Customer, CustomerAudit, Vendor, Circuit, CircuitAudit, IPAddressRecord, QualityProbeTarget
...
__all__ = [
    ...
    "Customer", "CustomerAudit", "Vendor", "Circuit", "CircuitAudit", "IPAddressRecord", "QualityProbeTarget",
